# Poco X3 NFC (Codename) `// Fill with your device and codename (Place in top files and make sure that only one)`
## Version - **8.1 Happiness (HOTFIX)** `// Fill with your build source version (Keep format Version - **Version + Codename**`
### **Build date** - 22 November 2025 `// Fill with your Build date (Keep format **Build date** - DATE)`
...
- Optimize perf
--- `// Add "---" at the end line for every updates changelogs`
...
- Add support scanner in Leica
- Implement torch light control (Flashlight Strenght)
- More improvement
